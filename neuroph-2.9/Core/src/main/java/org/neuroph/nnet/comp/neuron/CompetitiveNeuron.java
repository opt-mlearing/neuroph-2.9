...
/**
 * Provides neuron behaviour specific for competitive neurons which are used in competitive layers,
 * and networks with competitive learning.
 *
...
public class CompetitiveNeuron extends DelayedNeuron {
    ...
    public void addInputConnection(Connection connection) {
        ...
        if (connection.getFromNeuron().getParentLayer() == this.getParentLayer()) {
            // this.connectionsFromThisLayer =  Arrays.copyOf(connectionsFromThisLayer, connectionsFromThisLayer.length+1);
            ...
            // this.connectionsFromOtherLayers =  Arrays.copyOf(connectionsFromOtherLayers, connectionsFromOtherLayers.length+1);
            // grow existing connections  array to make space for new connection
