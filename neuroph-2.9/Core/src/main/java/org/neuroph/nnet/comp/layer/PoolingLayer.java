 ...
 * It contains neurons with max input function and method for creating pooling layer specific conectivity patterns.
 * The role of pooling layer is dimensionality and complexity reduction, while it keeps essential information.
 *
...
public class PoolingLayer extends FeatureMapsLayer {
    ...
    /**
     * Creates pooling layer with specified kernel, appropriate map dimensions in regard to previous layer(fromLayer param)
     * and specified number of feature maps with default neuron settings for pooling layer.
     * Number of maps in pooling layer must be the same as number of maps in previous layer.
     *
     * @param fromLayer previous layer, which will be connected to this layer
     * @param kernelDim kernel for all feature maps
     */
