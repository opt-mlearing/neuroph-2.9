 ...
 */
public class Perception extends NeuralNetwork {
     ...
     */
    public Perception(int inputNeuronsCount, int outputNeuronsCount) {
     ...
     */
    public Perception(int inputNeuronsCount, int outputNeuronsCount, TransferFunctionType transferFunctionType) {
